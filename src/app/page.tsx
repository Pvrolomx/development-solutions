          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <button onClick={() => handleSectionClick('inventario')}
              ...
              <div className="w-full aspect-square overflow-hidden">
                <img src="/icon-inventario.png" alt="Inventario" className="w-full h-full object-cover" />
              </div>
            ...
            <button onClick={() => handleSectionClick('compradores')}
              className="bg-white/10 backdrop-blur-sm rounded-3xl overflow-hidden shadow-lg border border-white/20 hover:bg-white/20 hover:scale-[1.02] transition-all duration-300 active:scale-95">
              <div className="w-full aspect-square overflow-hidden">
                <img src="/icon-compradores.png" alt="Compradores" className="w-full h-full object-cover" />
              </div>
              <div className="p-3 text-center">
            ...
            <button onClick={() => handleSectionClick('pagos')}
              className="bg-white/10 backdrop-blur-sm rounded-3xl overflow-hidden shadow-lg border border-white/20 hover:bg-white/20 hover:scale-[1.02] transition-all duration-300 active:scale-95">
              <div className="w-full aspect-square overflow-hidden">
                <img src="/icon-pagos.png" alt="Pagos" className="w-full h-full object-cover" />
              </div>
              <div className="p-3 text-center">
            ...
            <button onClick={() => handleSectionClick('inversionistas')}
              className="bg-white/10 backdrop-blur-sm rounded-3xl overflow-hidden shadow-lg border border-white/20 hover:bg-white/20 hover:scale-[1.02] transition-all duration-300 active:scale-95">
              <div className="w-full aspect-square overflow-hidden">
                <img src="/icon-inversionistas.png" alt="Inversionistas" className="w-full h-full object-cover" />
              </div>
              <div className="p-3 text-center">
            ...
            <button onClick={() => handleSectionClick('construccion')}
              className="bg-white/10 backdrop-blur-sm rounded-3xl overflow-hidden shadow-lg border border-white/20 hover:bg-white/20 hover:scale-[1.02] transition-all duration-300 active:scale-95">
              <div className="w-full aspect-square overflow-hidden">
                <img src="/icon-construccion.png" alt="Construcción" className="w-full h-full object-cover" />
              </div>
              <div className="p-3 text-center">
            ...
            <button onClick={() => handleSectionClick('gastos')}
              ...
              <div className="w-full aspect-square overflow-hidden">
                <img src="/icon-gastos.png" alt="Gastos" className="w-full h-full object-cover" />
              </div>
              <div className="p-3 text-center">
